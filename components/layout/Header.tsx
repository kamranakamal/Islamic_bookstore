...
const navItems: Array<{ href: string; label: string; Icon: NavIconComponent }> = [
...
function IconMenu({ className, ...props }: NavIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
function IconClose({ className, ...props }: NavIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
function IconHome({ className, ...props }: NavIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
function IconShop({ className, ...props }: NavIconProps) {
  return (
    <Image
      src="/shop_icon.svg"
      alt="Shop"
...
function IconScroll({ className, ...props }: NavIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
function IconSparkle({ className, ...props }: NavIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
function IconMail({ className, ...props }: NavIconProps) {
  return (
    <Image
...
function IconBoxes({ className, ...props }: NavIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
function IconQuestion({ className, ...props }: NavIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
function IconCart({ className, ...props }: NavIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
function IconOrders({ className, ...props }: NavIconProps) {
  return (
    <Image
